...
class InversableStableDiffusionXLPipeline(ModifiedStableDiffusionXLPipeline):
    def __init__(
        self,
        vae,
        text_encoder,
...
#
                ...
                if inv_order < 2 or (inv_order == 2 and i == 0):
                    ...
                    if (inverse_opt):
                        ...
                        if (inv_order == 2 and i == 0):
                            latents = self.fixedpoint_correction(latents, s, t, x_t, order=1, text_embeddings=text_embeddings, added_cond_kwargs=added_cond_kwargs, guidance_scale=guidance_scale,
                        ...
                        if (i + 1 < len(timesteps_tensor)):
                            ...
                            if inverse_opt:
                                latents = self.fixedpoint_correction(latents, s, t, x_t, order=2, r=r,
                                                                    model_s_output=model_s_output, model_r_output=model_r_output, text_embeddings=text_embeddings, added_cond_kwargs=added_cond_kwargs, guidance_scale=guidance_scale,
    ...
    def fixedpoint_correction(self, x, s, t, x_t, r=None, order=1, n_iter=500, step_size=0.1, th=1e-3,
                                model_s_output=None, model_r_output=None, text_embeddings=None, added_cond_kwargs=None, guidance_scale=3.0,
